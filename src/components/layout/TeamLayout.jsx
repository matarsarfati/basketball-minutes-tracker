...
import { Dumbbell, Home, Users, Calendar, Clock, CheckCircle2, LineChart, TestTube } from 'lucide-react';
    ...
    return (
        <div className="flex h-screen overflow-hidden bg-slate-50 font-sans">
            ...
            <div className="w-64 flex-shrink-0 bg-white border-r border-slate-200 shadow-sm flex flex-col z-20 relative">
                <div onClick={() => navigate('/')} className="p-6 border-b border-slate-100 bg-slate-50/50 cursor-pointer hover:bg-slate-100 transition">
                    ...
                    <div className="text-[10px] uppercase font-bold tracking-widest text-slate-400 mt-1">Change Team</div>
                </div>
